...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="./views/img/BG12.jpg" class="d-block w-100" alt="...">
...
$ResGuest = $data->getAllReservationGuest();
?>
<?php
if(isset($_POST['id'])){
    $RES = new ProductController();
...
?>
 ...
 <section id="rooms" class="rooms section-padding">
  <div class="container">
    ...
    <?php foreach($ResGuest as $ResGes):?>
      <div class="col-12 col-md-6 col-lg-4 mb-5">
        <div class="card text-light text-center bg-white pb-2">
          <div class="card-body text-dark">
            <div class="img-area mb-2">
              <img src="uploads/<?php echo $ResGes['image'];?>"style="width: 100%;height: 350px;" alt="">
              <h3 class="card-title pt-2"style="color:rgb(22, 109, 136);"><?php echo $ResGes['name'];?></h3>
              <h6 class="type" style="color:rgb(22, 109, 136);"><?php echo $ResGes['type'];?>
              <p class="pt-2">FROM <?php echo $ResGes['datedebut'];?> / TO <?php echo $ResGes['datefin'];?></p>
             <?php if($ResGes['type']=='SUITE'){ ?>
                <?php echo '/'. $ResGes['suitetype'];   
              }?>
              </h6>
              ...
              <h5 mb-3><?php echo $ResGes['price'];?>$/Night</h5>  
              <form action="reservation" method="POST">
              <input type="hidden" name="id" value="<?php echo $ResGes['id'];?>" >
              <button type="submit" name="deleteRes" style="border:none;padding:5px;border-radius:7px;">Delete Reservation</button>
              </form>           
            </div>
          </div>
        </div> 
